...
const Header = () => {
  ...
  return (
    <div className="w-full border-b border-gray-300 bg-gray-50">
      ...
      <div className=" flex justify-between items-center w-full h-24 mx-auto px-4 md:px-8">
        ...
        <div className="hidden md:flex items-center justify-between space-x-6 text-gray-600 text-sm " >
          <div className="flex items-center space-x-2">
            <FiPhone className="hover:text-orange-500 text-2xl"        />
          ...
          <div className="flex items-center space-x-2">
            <FiMail className="hover:text-orange-500 text-2xl" />
            <div className="flex flex-col">
              <span className="text-gray-400 uppercase text-xs">EMAIL US</span>
              <span className="text-orange-500 mailto:font-semibold">sales@babalkhibrah.com</span>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <BsClock className="hover:text-orange-500 text-2xl" />
            <div className="flex flex-col">
